...
const channels = [
    { id: 'jazHW1p92iQ', name: 'Introdução' },
    { id: '8ZQFQozjjno', name: 'Como passar o desenho para a tela' },
    { id: '0I5lU_xz7GI', name: 'Como queimar a tela' },
    { id: 'OvtKhooJG7M', name: 'Como pintar um céu nublado' },
    { id: 'FnE8cmpnxqw', name: 'Como pintar árvores' },
    { id: 'FXlo4kaYCN8', name: 'Como pintar árvores e pastagens' },
    { id: 'LqNQPiLtzq8', name: 'Como pintar um rio com reflexo' },
    { id: 'zpvySj0HI44', name: 'Como pintar os detalhes das árvores' },
    { id: 'Dg5PJLv8x9I', name: 'Como pintar uma casinha e o reflexo dela na água' },
    { id: 'l6vdpINUbXk', name: 'Como pintar os detalhes finais' }
];
